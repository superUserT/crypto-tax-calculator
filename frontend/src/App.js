    ...
    const calculate = async () => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(
                    errData.error || "Calculation failed on the server",
                );
            }
                                ...
                                >
                                    ...
                                    <header style={styles.header}>
                                        ...
                                        <p style={styles.subtitle}>
                                            Upload your transaction history and
                                            calculate capital gains using the
